...
Util.buildVehicleDetail = async function (data) {
  ...
  detail += '<div class="price-mileage">';
  detail += `<p class="price">Price: $${new Intl.NumberFormat("en-US").format(
    vehicle.inv_price
  )}</p>`;
  detail += `<p class="mileage">Mileage: ${new Intl.NumberFormat(
    "en-US"
  ).format(vehicle.inv_miles)}</p>`;
  detail += "</div>";
  detail += '<div class="vehicle-specs">';
  detail += `<p><span>Color:</span> ${vehicle.inv_color}</p>`;
  detail += `<p><span>Description:</span> ${vehicle.inv_description}</p>`;
  detail += "</div>";
  detail += "</div>";
  detail += "</div>";
  return detail;
